...
class PushPayload
{
    ...
    public function addRegistrationId($registrationId)
    {
        ...
        } elseif (is_string($registrationId)) {
    ...
    {
        $response = $this->client->_request(self::PUSH_URL, JPush::HTTP_POST, $this->toJSON());
    ...
    {
        $response = $this->client->_request(self::PUSH_VALIDATE_URL, JPush::HTTP_POST, $this->toJSON());
