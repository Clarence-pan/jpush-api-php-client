...
class DevicePayload
{
    ...
    {
        $url = self::DEVICE_URL.$registrationId;
    ...
    {
        $response = $this->client->_request(self::TAG_URL, JPush::HTTP_GET);
    ...
    public function getDevicesStatus($registrationId)
    {
        ...
        $response = $this->client->_request(self::DEVICE_STATUS_URL, JPush::HTTP_POST, json_encode($payload));
